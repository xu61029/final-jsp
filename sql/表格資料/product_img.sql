...
select products.pdid,products.pdkind,sum(products_color.stock) as total,products.pdname,MIN(product_img.imgurl),min(product_img.class) as pdclass,products.price
